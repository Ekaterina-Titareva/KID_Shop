...
function makeBasketItem (data, value) {
  let basketList = document.querySelector('.basket-list-catalog');
...
window.addEventListener('DOMContentLoaded',() => {
  let deleteButtons = document.querySelector('.basket-list-catalog').querySelectorAll('.delete-btn-catalog');
